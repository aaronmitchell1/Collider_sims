rm(list=ls())
setwd("/user/home/vc23656/Collider_sims/inc_int")
...
for (n in 1:reps) {
  ...
  incidence.probs <- expit(-1 + as.vector(G %*% incidence.betas) + 1 * U + beta_int*G[1]*U + beta_int*G[2]*U + beta_int*G[3]*U + beta_int*G[4]*U + beta_int*G[5]*U) 
