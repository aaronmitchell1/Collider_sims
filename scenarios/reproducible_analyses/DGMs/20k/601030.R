rm(list=ls())
setwd("/user/home/vc23656/Collider_sims/601030")
expit <- function (x) exp(x) / (1 + exp(x))
set.seed(54545)
reps <- 1000
n.ind <- 2e5
nSNPs <- 100
incidence.SNPs <- c(1:60, 71:100) 
progression.SNPs <- c(61:70, 71:100)
...
for (n in 1:reps) {
  ...
  save(loop_incidence_GWAS, loop_progression_GWAS, loop_progression_oracle_GWAS, loop_methods, incidence_rsq, progression_rsq, collider_rsq, correlation_coef, incidence_mean, progression_mean, loop_Pobs, loop_P, loop_I, loop_var_interaction, file = 'sim_results.RData')
